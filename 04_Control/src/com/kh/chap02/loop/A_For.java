...
public class A_For {
	...
	public void method3() {
		// 1과 10 사이의 정수 중 "홀수만 출력하는 반복문을 만드시오
		// 출력 결과 : 1 3 5 7 9 
		// 초기식: int i = 1;
	...
	public void method6() {
		//문자열의 문자를 반복
		String str = "abcefghijk"; // 문자열 길이 6
	...
	public void method7() {
		...
		*/
		...
		for(int i = 1; i<10; i++) {
			System.out.println(lank + " x " + i + " = " + lank * i);
		}
	}
