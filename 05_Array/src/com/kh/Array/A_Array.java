...
public class A_Array {
	 ...
	 * int a = 10;
	 * 
	 * 배열 : 하나의 공간에 여러개의 값을 담을 수 있다. (같은 자료형)
	 * 		ex) int[] a = new int[3];
	 ...
	 * 		배열의 크기가 n이라면, 해당 배열의 마지막 인덱스는 n-1
	 * 		
	 */
	...
	public void method1() {
		...
		/*
		 * 배열 할당
		 * - 이 배열에 몇 개의 값들을 보관할 건지 그 배열의 크기를 지정해주는 과정
		 * - 크기를 지정해주면, 지정한 갯수만큼 저장공간을 가진 배열이 생성
		 * [표현법]
		 * 배열명 = new 자료형 [배열크기];
		 * */
	...
	public void method2() {
		...
		//모든 참조형 자료 변수는 주소값을 호출한다.
		System.out.println("iArr: " + iArr); //배열에 저장한 값이 아닌 주소값이 나옴
		
		System.out.println("iArr의 HashCode : "+ iArr.hashCode()); //주소값을 10진수형태로 변경해주는 함수
	...
	public void method7() {
		...
		//Arrays.toString(배열) => 배열 내부의 값들을 문자열들로 변환하여 반환하는 메서드
